...
STK.register("common.feed.inter.myFeedInter", function($) {
	...
	var inter = function (opts) {
		...
		if($CONFIG.uid != null){
			...
			throw new Error("[common.feed.inter.myFeedInter]: $CONFIG.uid is undefined.");
		}
...
//		}
	...
	inter.prototype.collectParameter = function (type) {
		...
		if(this.uid !== ""){
			...
			$.log("[common.feed.inter.myFeedInter]: $CONFIG.uid is undefined.");
		}

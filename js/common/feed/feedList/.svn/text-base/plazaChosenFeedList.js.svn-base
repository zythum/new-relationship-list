...
$Import('common.feed.feedList.plugins.moreFeed');

STK.register("common.feed.feedList.plazaChosenFeedList", function($) {
	...
	return function(node, opts) {
		...
		pluginList.push(shorter.moreFeed(that, {count:50, maxloadNum:20}));
